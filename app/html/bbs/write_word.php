...
<header id="header" class="fixed top-0 w-full bg-white/95 backdrop-blur-sm z-50 border-b border-soft-lavender">
    <div class="flex items-center justify-between px-4 py-3">
        ...
        <h2 class="text-base font-semibold text-grace-green"><?php echo $w == 'u' ? '말씀 수정' : '오늘의 말씀 등록'; ?></h2>
        <div class="w-6"></div>
    </div>
</header>
    ...
    <div class="max-w-2xl mx-auto px-4 py-4">
        <div class="bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <!-- 안내 메시지 -->
                <div class="px-4 pt-4 pb-3 bg-gradient-to-r from-purple-50 to-pink-50">
                    <div class="flex items-start gap-2 text-sm text-purple-800">
                        <i class="fa-solid fa-info-circle mt-0.5"></i>
                        <div>
                            <p class="font-medium mb-1">오늘의 말씀을 나누어 주세요</p>
                            <p class="text-xs text-purple-600">YouTube 영상 URL을 내용에 붙여넣으면 자동으로 영상이 표시됩니다</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-4 pt-4 pb-3 border-b border-gray-100">
                    <input
                        ...
                        placeholder="말씀 제목을 입력하세요... (예: 요한복음 3:16)"
                        maxlength="255">
                </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <textarea
                                ...
                                placeholder="말씀 내용을 입력하세요...&#10;&#10;YouTube 영상 URL을 붙여넣으면 자동으로 영상이 표시됩니다.&#10;예) https://www.youtube.com/watch?v=..."
                                rows="8"
                                style="min-height: 150px;"><?php echo $content; ?></textarea>
                        </div>
                    </div>
                </div>
...
<div class="fixed bottom-0 w-full bg-white border-t border-soft-lavender z-40 px-4 py-3">
    <div class="max-w-2xl mx-auto">
        <button type="button" id="btn_submit" onclick="submitPost()"
            ...
            <i class="fa-solid fa-book-bible mr-2"></i><?php echo $w == 'u' ? '수정하기' : '말씀 등록하기'; ?>
        </button>
    </div>
</div>
...
function fwrite_submit(f) {
    ...
    if (btn_submit) {
        ...
        btn_submit.innerHTML = '<i class="fa-solid fa-spinner fa-spin mr-2"></i>등록 중...';
    }
