...
define('G5_NO_PROFILE_IMG', '<span class="profile_img"><img src="'.G5_IMG_URL.'/no_profile.gif" alt="no_profile" width="'.($config['cf_member_icon_width'] ?? '22').'" height="'.($config['cf_member_icon_height'] ?? '22').'"></span>');
